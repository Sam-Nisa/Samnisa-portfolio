...
const Education = () => {
  ...
  const educationData = [
    ...
    {
      id: 3,
      institution: "Prey Kley high School",
      duration: "2020 - 2022",
      program: "High School Education",
      description:
        "During my time at Prey Kley high School, I developed a strong academic foundation while actively engaging in various subjects and extracurricular activities.",
      type: "high-school",
      status: "completed",
      side: "right",
      icon: Award,
    ...
    },
    {
      ...
      description:
        "My education at Prey Kley high School provided me with essential knowledge and skills in various subjects, fostering my interest in technology and analytical thinking.",
      type: "secondary",
      status: "completed",
      side: "left",
      icon: BookOpen,
